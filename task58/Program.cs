...
Console.WriteLine("Введите число строк m1");
int rows1 = int.Parse(Console.ReadLine()!);

Console.WriteLine("Введите число столбцов n1");
int columns1 = int.Parse(Console.ReadLine()!);

int[,] arrayA = new int[rows1, columns1];

Console.WriteLine("Введите число строк m2");
int rows2 = int.Parse(Console.ReadLine()!);

Console.WriteLine("Введите число столбцов n2");
